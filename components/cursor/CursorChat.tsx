...
const CursorChat = ({cursor, cursorState, setCursorState, updateMyPresence}: CursorChatProps) => {
    ...
    //To change the state we require certain functions 
           ...
           ( 
             <>
                ...
                <div className='absolute left-2 top-5 bg-blue-500 px-4 py-2 text-sm leading-relaxed
                 text-white rounded-[20px]' onKeyUp={(e) => e.stopPropagation()}>
                    ...
                    placeholder= {cursorState.previousMessage ? "":"Hey ,Buddy Say Something..."}
